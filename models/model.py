...
class ResidualBlockStraight(nn.Module):
    def __init__(self, in_channels, out_channels, dilation=1, last=False):
        ...
        self.conv1 = res_conv(in_channels, out_channels // 4, dil=dilation)  # Fixed integer division
        self.conv2 = res_conv(out_channels // 4, out_channels // 4)  # Fixed integer division
        self.conv3 = res_conv(out_channels // 4, out_channels)  # Fixed integer division
...
class ResidualBlockDown(nn.Module):
    def __init__(self, in_channels, out_channels, dilation=1, last=True):
        ...
        self.conv2 = res_conv(in_channels, in_channels // 2)  # Fixed integer division
        self.conv3 = res_conv(in_channels // 2, in_channels // 4)  # Fixed integer division
        self.conv_out = nn.Conv2d(in_channels + in_channels // 4, out_channels, 3, 1, 1)  # Fixed integer division
        self.relu = nn.ReLU(inplace=True)
        self.tanh = nn.Tanh()
        self.last = last
